...
let row3 = getRow([{ text: 'Food', checkboxes: ['Indian', 'Chinese', 'Mexican'] },
{ text: 'Gender', options: ['Male', 'Female'] }], 'select')

let row4 = createElement('div', 'row');
let col = createElement('div', 'col-12')
let button1 = createElement('button', 'btn btn-success')
button1.type = 'submit';
button1.innerText = 'Submit';
let button2 = createElement('button', 'btn btn-warning ml-2');
...
let foods = { Indian: false, Chinese: false, Mexican: false }
